...
exports.description = 'The Authorization header only needs to contain recorder credentials.';
...
exports['x-amazon-apigateway-integration'] = {
  ...
  requestTemplates: {
    'application/json': '{"Authorization": "$input.params(\'Authorization\')", "api_key": "$input.params(\'X-Api-Key\')", "recorder_id": "$input.params(\'recorder_id\')", "account_id": "$input.params(\'account_id\')"}',
  },
  responses: {
